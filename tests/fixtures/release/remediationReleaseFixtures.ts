...
const REDACTED_COMMAND_TEMPLATES = {
  ...
  full_regression: "npm run typecheck && node <repo>/node_modules/vitest/vitest.mjs run --configLoader bundle --no-file-parallelism --testTimeout=300000 --hookTimeout=300000 && git diff --check && release:scope-audit && release:postgres-cleanup",
