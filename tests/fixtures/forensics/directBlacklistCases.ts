...
export const TGYT_DIRECT_BLACKLIST_CASE = {
  ...
  // ponytail: synthetic fixture models one GasFree settlement; principal and fee share its parent tx.
  gasFreeFeeTxHash: "2".repeat(64),
...
export function tgytDirectInteractionProfiles(): DirectCounterpartyInteractionProfile[] {
  ...
  return [{
    ...
    volumeRatio: 0,
    txCount: 1,
    firstSeen: "2026-05-26T09:56:18.000Z",
    lastSeen: "2026-05-26T09:56:18.000Z",
