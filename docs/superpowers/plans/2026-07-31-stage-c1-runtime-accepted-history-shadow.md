...
- Task 7 is complete in code. Completion carries `checkpointCommit:null` into
  ...
  ordered-commit PostgreSQL pass `21/21 + 18/18` with zero skips. Tasks 8-10
