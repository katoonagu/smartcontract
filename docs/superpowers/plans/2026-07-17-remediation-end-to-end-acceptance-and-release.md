...
| `G11_POISONING_REGRESSION` | exact `suite-addressPoisoningRegression.vitest.json` plus `suite-addressPoisoningRegression.evidence.json` only | `pre_manual` | return separate owner/block |
